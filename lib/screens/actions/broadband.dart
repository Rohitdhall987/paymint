...
class BroadbandRechargeScreen extends StatelessWidget {
  const BroadbandRechargeScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Broadband Recharge", style: TextStyle(color: AppColors.textPrimary)),
        centerTitle: true,
      ),
      body: Padding(
            ...
            GlassContainer(
              ...
              child: DropdownButtonFormField<String>(
                decoration: const InputDecoration(
                  labelText: "Select Broadband Provider",
                  border: InputBorder.none,
                ),
                dropdownColor: AppColors.background,
                items: ["Airtel", "Jio Fiber", "ACT", "BSNL"]
